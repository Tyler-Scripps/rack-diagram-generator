...
def createSwitch(switchObj, rackSize):
    ...
    tempGroup.add(dwg.rect(insert=(".5in",str(height)+"in"), size=("19in",str(switchObj["size"]*1.75)+"in")))
    tempGroup.add(dwg.circle(center=(".8125in",str(height+.25)+"in"), r=".1in", fill="#555555"))
    tempGroup.add(dwg.circle(center=(".8125in",str(height+1.5)+"in"), r=".1in", fill="#555555"))
    tempGroup.add(dwg.circle(center=("19.1875in",str(height+.25)+"in"), r=".1in", fill="#555555"))
    tempGroup.add(dwg.circle(center=("19.1875in",str(height+1.5)+"in"), r=".1in", fill="#555555"))
